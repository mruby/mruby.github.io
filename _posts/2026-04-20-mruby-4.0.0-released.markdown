...
The main changes in mruby 4.0 are also described in [doc/mruby4.0.md](https://github.com/mruby/mruby/blob/master/doc/mruby4.0.md).
...
We have done 1,844 commits to 473 files with 82,458 additions and 14,976 deletions since mruby 3.4.0. For more detail of the updates, [see Commit Log](https://github.com/mruby/mruby/compare/3.4.0...4.0.0).

Thanks to all the contributors who have worked on bug fixes and improvements in the release of `mruby 4.0.0`.
